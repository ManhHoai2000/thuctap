...
import com.hshop.bean.MailInfo;
import com.hshop.dao.UserDAO;
import com.hshop.entity.Order;
import com.hshop.entity.User;
import com.hshop.service.CookieService;
import com.hshop.service.MailService;
...
public class AccountController {
	...
	public String register(Model model, @Validated @ModelAttribute("form") User user, BindingResult errors, //đọc dữ liệu từ form gửi lên
		...
		String from = "hshopcontact2021@gmail.com";
		String to = user.getEmail();
		String subject = "Welcome!";
		String url = request.getRequestURL().toString().replace("register", "activate/" + user.getId());
		String body = "H shop xin chào! Vui lòng nhấn vào <a href='" + url + "'>Activate</a> để kích hoạt tài khoản.";
