...
<c:set var="cart" value="${sessionScope['scopedTarget.cartService']}" />
              ...
              <div id="demo" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="/static/images/slideshow/slide1.jpg" alt="Los Angeles" width="100%" >
					</div>
					<div class="carousel-item">
						<img src="/static/images/slideshow/slide2.jpg" alt="Los Angeles" width="100%" >
					</div>
					<div class="carousel-item">
						<img src="/static/images/slideshow/slide3.jpg" alt="Los Angeles" width="100%" >
					</div>
					<div class="carousel-item">
						<img src="/static/images/slideshow/slide4.jpg" alt="Los Angeles" width="100%" >
					</div>
				</div>
              </div>
		</div>
	...
	<!-- slide -->
	<br> <img src="https://hoanghamobile.com/Uploads/2021/06/10/hotsale-iphone-xr-1006-v2-0.gif" alt="" width="100%" >
